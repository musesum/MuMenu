...
//public struct MenuOp_Corner: OptionSet {
//
//    public let rawValue: Int
//    static func flipUpperLower(_ oldOp: Int) -> Int {
//        return oldOp ^ MenuOp([.upper,.lower]).rawValue
//    }
//
...
//    }
//
//    public static let upper = MenuOp(rawValue: 1 << 0) // 1
//    public static let lower = MenuOp(rawValue: 1 << 1) // 2
//    public static let left  = MenuOp(rawValue: 1 << 2) // 4
//    public static let right = MenuOp(rawValue: 1 << 3) // 8
//
...
//
//    var chiral: Chiral { self.right ? .right : .left}
//
//    var side  : Int { rawValue & MenuOp([.left,.right]).rawValue }
//
...
//        let result: [String] = Self.description.filter { contains($0.0) }.map { $0.1[0] }
